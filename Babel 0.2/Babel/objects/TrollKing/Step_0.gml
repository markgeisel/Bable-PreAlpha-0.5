...
if ballspawn  =0     {
with instance_create_layer(x,y,"Instances_1_1",TrollballKing){
target = other.id 

}

with instance_create_layer(x,y,"Instances_1_1",TrollballKing2){
target = other.id 
...
switch(display_dir) {
case 0: sprite_index = SprHurtRight ; break;

case 1: sprite_index = SprHurtUp; break;

case 2: sprite_index = SprHurtLeft; break;

case 3: sprite_index = SprHurtDown; break;

case 4: sprite_index = SprHurtRight; break;
}}
