function lighting_global() {
	...
	global.lightMaxUniqueShadowMapSize = 250;

	// Delay in frames between light updates
	// You can force the lighting system to update with li	ghting_set_dirty(true)
...
#macro __LIGHT_LINE_SHADOW_CASTER_STEP 1
