...

{
	...
	if direction >=  135 && direction <= 225 &&form==0{
		if state != Playerstate_free && state != Playerstate_locked && state != Playerstate_transition && state !=  Playerstate_dodge
	...
	if direction >=  135 && direction <= 225 &&form==1{
		if state != Playerstate_free && state != Playerstate_locked && state != Playerstate_transition && state !=  Playerstate_dodge
	...
	if direction > 225 && direction <= 310 && form== 0{
		if state != Playerstate_free && state != Playerstate_locked && state != Playerstate_transition&& state != Playerstate_dodge
	...
	if direction > 225 && direction <= 310 && form== 1{
		if state != Playerstate_free && state != Playerstate_locked && state != Playerstate_transition&& state != Playerstate_dodge
